window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function resolveChatFeed(session, binding) {
			if (session === void 0 || binding === void 0) return void 0;
		...
		*/
		...
		function OutlinePanel({ sessions, useSessions, t }) {
			...
			const chat = (0, react.useMemo)(() => resolveChatFeed(session, current ? sessions.binding(current) : void 0), [
				session,
				sessions,
				current
			]);
