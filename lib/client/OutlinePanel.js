...
export function OutlinePanel({ sessions, useSessions, t }) {
    ...
    useEffect(() => {
        ...
        if (open)
            root.setAttribute('data-dsh-outline-open', '');
        else
            root.removeAttribute('data-dsh-outline-open');
